$(document).ready(function() {
    ...
    let contentArray = [
        ...
        "Now, years into this fascinating world, my passion for both the Front-End and Back-End aspects of web development has only grown. My last, longest journey was my final college project — a marketplace web application customized for wedding purposes - that aims to solve real-world problems with innovative digital solutions. This project is not just a culmination of my academic learning but a testament to my self-taught expertise and dedication to mastering web development."
    ];
